...
ActiveRecord::Schema[8.1].define(version: 2026_08_13_153000) do
  ...
  create_table "proxy_inventory_quantities", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "event_id", null: false
    t.integer "item_index", null: false
    t.integer "quantity"
    t.datetime "updated_at", null: false
    t.index ["event_id", "item_index"], name: "index_proxy_inventory_quantities_on_event_id_and_item_index", unique: true
    t.index ["event_id"], name: "index_proxy_inventory_quantities_on_event_id"
  end
  ...
  add_foreign_key "proxy_inventory_quantities", "events"
end
